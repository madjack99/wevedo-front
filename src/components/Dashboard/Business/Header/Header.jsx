...
const DashboardBusinessHeader = ({ user }) => {
  return (
    <React.Fragment>
      <Navbar
      ...
      >
        ...
        <Navbar.Collapse>
          <Nav className="text-uppercase mr-auto">
            ...
            <LinkContainer to="/dashboard/business/account">
              <Nav.Link>
...
export default connect(mapStateToProps)(DashboardBusinessHeader);
